(function () {
  ...
  window.NalameConfig = {
    ...
    questionMedia: {},
    questions: [
      { id: 'question-01', text: 'What best describes your current work situation?', conversation: 'Let us start with where you are today.', answers: [
      ...
      { id: 'question-02', text: 'What made you decide to explore new opportunities today?', conversation: 'Now let us understand what is motivating you.', answers: [
      ...
      { id: 'question-03', text: 'If nothing changed over the next 12 months, how would you feel?', conversation: 'That gives us a sense of how important change feels right now.', answers: [
      ...
      { id: 'question-04', text: 'Imagine it is one year from today. What is the biggest improvement you would like to see?', conversation: 'That future picture is important. Let us make it more specific.', answers: [
      ...
      { id: 'question-05', text: 'How satisfied are you with your current income and career path?', conversation: 'Thanks for being honest. This helps us understand how much change you may be looking for.', answers: Array.from({length:10}, function(_, i) { var n = i + 1; return { id: 'q05-a' + String(n).padStart(2, '0'), text: n === 1 ? '1 - Not satisfied' : n === 10 ? '10 - Very satisfied' : String(n), conversation: 'Thanks. Let us see what kind of improvement matters most.' }; })},
      { id: 'question-06', text: 'What monthly income would make you feel financially comfortable?', conversation: 'Now let us understand the level of opportunity you are aiming for.', answers: [
      ...
      { id: 'question-07', text: 'What appeals most to you about locksmithing?', conversation: 'Great. This helps us understand what part of the profession connects with you personally.', answers: [
      ...
      { id: 'question-08', text: 'Have you ever considered owning your own business?', conversation: 'Let us look at whether independence is part of your long-term picture.', answers: [
      ...
      { id: 'question-09', text: 'How much time can you realistically dedicate each week to learning a new skill?', conversation: 'Consistency matters more than trying to do everything at once.', answers: [
      ...
      { id: 'question-10', text: 'What is your biggest challenge right now?', conversation: 'Knowing the obstacle helps us understand what support matters most.', answers: [
      ...
      { id: 'question-11', text: 'Which statement sounds most like you?', conversation: 'This tells us what kind of roadmap would feel most useful to you.', answers: [
      ...
      { id: 'question-12', text: 'If you became a locksmith, what excites you most?', conversation: 'The best path is one that connects with what you actually care about.', answers: [
      ...
      { id: 'question-13', text: 'Who would benefit most if your income improved?', conversation: 'Personal reasons often create the strongest motivation to keep going.', answers: [
      ...
      { id: 'question-14', text: 'How ready are you to make a positive change this year?', conversation: 'Readiness helps us understand whether you are exploring or prepared to take action.', answers: Array.from({length:10}, function(_, i) { var n = i + 1; return { id: 'q14-a' + String(n).padStart(2, '0'), text: n === 1 ? '1 - Just exploring' : n === 10 ? '10 - Ready to take action' : String(n), conversation: 'Thanks. Let us finish your profile.' }; })},
      { id: 'question-15', text: 'If we showed you a clear step-by-step roadmap, what would you want to achieve first?', conversation: 'Let us finish by choosing the first milestone that matters most.', answers: [
