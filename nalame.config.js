(function () {
  ...
  window.NalameConfig = {
    ...
    questions: [
      { id: 'question-01', text: 'Lorem ipsum dolor sit amet, consectetur?', answers: [
      ...
      { id: 'question-02', text: 'Sed posuere consectetur est at lobortis?', answers: [
        { id: 'q02-a01', text: 'Aenean lacinia bibendum nulla' },
        { id: 'q02-a02', text: 'Cras justo odio dapibus ac' }
      ] },
      { id: 'question-03', text: 'Maecenas faucibus mollis interdum vivamus sagittis?', answers: [
      ...
      { id: 'question-04', text: 'Morbi leo risus porta ac consectetur ac vestibulum?', answers: [
      ...
      { id: 'question-05', text: 'Curabitur blandit tempus porttitor integer posuere?', answers: [
        { id: 'q05-a01', text: 'Ridiculus mus sociis natoque' },
        { id: 'q05-a02', text: 'Venenatis dapibus posuere velit' }
      ] },
      { id: 'question-06', text: 'Aenean eu leo quam pellentesque ornare sem?', answers: [
      ...
      { id: 'question-07', text: 'Donec sed odio dui cras mattis consectetur?', answers: [
      ...
      { id: 'question-08', text: 'Vestibulum id ligula porta felis euismod semper?', answers: [
        { id: 'q08-a01', text: 'Commodo luctus nisi erat' },
        { id: 'q08-a02', text: 'Bibendum sagittis lacus vel' }
      ] },
      { id: 'question-09', text: 'Nullam quis risus eget urna mollis ornare?', answers: [
      ...
      { id: 'question-10', text: 'Etiam porta sem malesuada magna mollis euismod?', answers: [
